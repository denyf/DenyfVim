...
if dap and dapui and vt then
  local cfg = require("denyf").config
  require("denyf.dap.nvim-dap.ui")
  ...
  if cfg.lua and cfg.lua.enable then
    require("denyf.dap.nvim-dap.config.lua").setup()
  end
  ...
  --   require("denyf.dap.nvim-dap.config.cpp").setup()
  -- end

  if cfg.frontend and cfg.frontend.enable then
    require("denyf.dap.nvim-dap.config.vscode-js")
  end

  require("denyf.dap.nvim-dap.common-config").keyAttach()
end
