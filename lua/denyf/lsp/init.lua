...
mason_config.setup({
  ensure_installed = require("denyf.env").getLSPEnsureList(),
})

mason_tool.setup({
  ensure_installed = require("denyf.env").getToolEnsureList(),
})

local servers = require("denyf.env").getLSPConfigMap()
