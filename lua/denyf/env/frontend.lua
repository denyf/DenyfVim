...
return function(config)
  return {
    ...
    getLSPConfigMap = function()
      local list = {
        tsserver = require("denyf.lsp.config.typescript"),
        cssls = require("denyf.lsp.config.css"),
        emmet_ls = require("denyf.lsp.config.emmet"),
        html = require("denyf.lsp.config.html"),
      }
      if config.tailwindcss then
        list.tailwindcss = require("denyf.lsp.config.tailwindcss")
      end
      if config.vue then
        list.volar = require("denyf.lsp.config.volar")
      end
      if config.prisma then
        list.prismals = require("denyf.lsp.config.prismals")
      end
